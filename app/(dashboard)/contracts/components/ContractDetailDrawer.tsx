...
export function ContractDetailDrawer({
  ...
  return (
    <div className={isPageMode
      ...
      <div className={`${isPageMode ? 'pt-5' : 'p-6 border-t border-border bg-slate-50/50'} flex gap-2`}>
        <a
          href={`/contracts/${contract.id}/print`}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 px-3 py-2 rounded-lg border border-border bg-card text-xs font-semibold text-slate-700 hover:bg-muted transition-all cursor-pointer"
        >
